...
main = defaultMainWith settings  [
         ...
         , bgroup "Pollards's Algorithm" [
           ...
           , bench "52635022169628958833592981554606658319"                  $ nf (pollards 52635022169628958833592981554606658319)                  10000000
           , bench "1579057808224947489159455409497076163663656780411374497" $ nf (pollards 1579057808224947489159455409497076163663656780411374497) 10000000
         ] 
       ]
