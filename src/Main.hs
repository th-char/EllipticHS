...
main = defaultMainWith settings  [
        ...
        , bench "63848464823743824761 * 18734534234234234587"             $ nf runLenstra 1196171250043728979819625030660693208707
        , bench "50000000000000000059 * 3000000000000000000000007"        $ nf runLenstra 150000000000000000177000350000000000000000413
